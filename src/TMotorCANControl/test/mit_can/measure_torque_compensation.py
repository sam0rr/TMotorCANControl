...
bias = (
    0.82380554157 + 0.27416231671018404 - 0.5243091399609011
)  #  0.5896742308538513 # Nm
delay = 20.0  # s
        ...
        with open(csv_file_name, "w") as fd:
            ...
            writer.writerow(
                [
                    ...
                    "adc_measured_torque",
                    "motor_measured_torque",
                    "motor_measured_current",
                    "motor_measured_speed",
                ]
            )
            ...
            for t in loop:
                ...
                dev.update()
                writer.writerow(
                    [t, torque, adc.get_torque() - bias, dev.τ, dev.i, dev.θd]
                )
                dev.τ = torque
